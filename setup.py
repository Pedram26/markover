...
setup(
  ...
  url = bytes('https://github.com/Pedram26/markover', 'utf-8'), # use the URL to the github repo
  download_url = bytes('https://github.com/pedram26/markover/archive/1.1.tar.gz', 'utf-8'),
